		...
		<header class="w3-container w3-top" style="padding:0px;margin:0px;">
			...
			<div class="w3-container w3-sand w3-hide-medium w3-bottombar w3-border-black w3-hide-small" style="width:90%;margin:0 auto;padding:0px 30px;">
				<div class="w3-row" style="">
					...
					<div > 
				<form name="bbbbbb" action="" method="post">
				<p><button name="log"  class="w3-btn w3-black w3-hover-white w3-round fa fa-arrow-right" id="log"> logout  </button> </p>
...
?>
			 ...
			 <p align="left"><button name="edit" class="w3-btn w3-black w3-hover-white w3-round fa fa-arrow-right" id="edit"><a href="editprofile.php"> EDIT  </button> </p>
			 <p align="left"><button name="afterlogin" class="w3-btn w3-black w3-hover-white w3-round fa fa-arrow-right" id="afterlogin"><a href="afterlogin.php"> Upload Project  </button> </p>
			</div>

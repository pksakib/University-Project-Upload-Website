...
<html>
	...
	<body class="w3-container w3-myback" style="padding:0px;">
		...
		<h3 align="center">SELECT TYPE</h3>
		
		
			<div class="w3-container" style="margin:0px 0px 0px 0px;padding:0px;" >
			 <p align="center">
				<button class="w3-btn w3-black w3-hover-white w3-round fa fa-arrow-right" id="upload"><a href="allprojectaca.php"> All Academic Project  </button>
				<button class="w3-btn w3-black w3-hover-white w3-round fa fa-arrow-right" id=""><a href=" allprojectnon.php">  All Non Academic Project </button> 
			 </p>
			</div>

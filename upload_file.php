...
<?php
				...
				if (isset($_REQUEST['submit']))
				{
					...
					$sql= "INSERT INTO `academic_project`( `project_name`, `project_description`,`course_name`,`course_code`,`user_id`) VALUES  ('".$pname."', '".$pdes."','".$coursename."','".$coursecode."','".$_SESSION["u_id"]."')";
					$sql2= "INSERT INTO `technology`( `technology_name`) VALUES ('".$techname."')";
					//$sql3= "INSERT INTO `course`( `course_name`,`course_code`) VALUES ('".$coursename."','".$coursecode."')";
					if( !empty($pname) && !empty($pdes) && !empty($techname) && !empty($coursename) && !empty($coursecode))
					{
		...
		<h3 align="center">Upload Project</h3>
			...
			<div class="w3-container" style="margin:0px 50px 50px 180px;padding:0px;" >
			 <p>
				...
				<p>Course Name <input id="cn" class="cn" name="course_name" type="text" size="20" placeholder="Course Name" /> Course Code <input name="course_code" type="text" size="20" placeholder="Course Code" /> </p>

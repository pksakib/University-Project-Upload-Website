...
<html>
	...
	<body class="w3-container w3-myback" style="padding:0px;">
		...
		<p align="center"><img src="img/t.jpg"  style="width:100%;max-width:140px;"></p>
		
			<div class="w3-container" style="margin:0px 50px 50px 180px;padding:0px;" >
			 
			 <p>
				<h4>This our web engineering project. We are a team , team member are Sakib, Tahmida, Sirat. We are the students of North East University Bangladesh, Sylhet. Our course teacher is Miss. Tazbeea Tazakka Oushneek mam.  </h4>

...
<html>
	...
	<body class="w3-container w3-myback" style="padding:0px;">
		...
		<h3 align="center">ALL NON ACADEMIC PROJECT LIST</h3>
    ...
    <tbody>
        ...
        <?php
			...
			if (mysqli_connect_errno())
			{
			    ...
			    $result = mysqli_query($con,"SELECT project_name,project_description FROM `non_academic_project` ");
				$non = 'non_academic_project_id';
							$sql2="select $non from non_academic_project";
							$nonid = mysqli_query($con,$sql2);
							//$_SESSION["non_id"] = mysqli_fetch_object($nonid)->$non;
				...
				while($row = mysqli_fetch_array($result))
				{
					echo "<tr>";
					//echo "<td>" . $sendid . "</td>";
					echo "<td>" .$_SESSION["non_id"] = mysqli_fetch_object($nonid)->$non. "</td>";
					
					echo "<td><a href=\"showbproject.php?idn=".$_SESSION["non_id"]."\">" . $row['project_name'] . "</td>";
